      ...
      <Dialog open={shortcutsOpen} onOpenChange={setShortcutsOpen}>
        <DialogContent className="max-h-[min(640px,calc(100vh-2rem))] max-w-xl overflow-y-auto">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50/60 p-3">
            <div className="min-w-0">
              <div className="text-sm font-semibold text-slate-900">
                {t("shortcuts.actions.toggleMarkdown.label") || "切换 Markdown/富文本"}
              </div>
              <div className="mt-0.5 text-xs leading-4 text-slate-500">
                {t("shortcuts.actions.toggleMarkdown.description") || "在 Markdown 源码与富文本编辑之间切换。"}
              </div>
            </div>
            <div className="mt-2 flex items-center gap-2">
              <kbd className="inline-flex h-7 min-w-[2rem] items-center justify-center rounded-md border border-slate-300 bg-white px-2 font-mono text-xs font-semibold text-slate-700 shadow-sm">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50/60 p-3">
            <div className="min-w-0">
              <div className="text-sm font-semibold text-slate-900">
                {t("shortcuts.actions.saveMemo.label") || "保存笔记"}
              </div>
              <div className="mt-0.5 text-xs leading-4 text-slate-500">
                {t("shortcuts.actions.saveMemo.description") || "立即保存当前笔记。"}
              </div>
            </div>
            <div className="mt-2 flex items-center gap-2">
              <kbd className="inline-flex h-7 min-w-[2rem] items-center justify-center rounded-md border border-slate-300 bg-white px-2 font-mono text-xs font-semibold text-slate-700 shadow-sm">
